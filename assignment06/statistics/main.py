...
class Statistics:
    ...
    def __init__(self, lower_bound: int, upper_bound: int, step_size: int):
        # create values with list comprehension and range object
    ...
    while True:
        ...
        while True:
            ...
            if lower_bound in [upper_bound - 1, upper_bound + 1]:
                print(f"Invalid input: The boundaries {lower_bound, upper_bound} are too close to\n"
        ...
        stats: Statistics = Statistics(lower_bound, upper_bound, step_size)
